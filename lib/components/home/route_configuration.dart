  ...
  Widget build(BuildContext context) => Column(
    ...
    children: <Widget>[
      ...
      Container(
        ...
        decoration: const BoxDecoration(
          border: Border(bottom: BorderSide(color: Colors.brown, width: 2.0)),
        ),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch,
          children: globals.metaData.comicFilterGroupList.map((grp) => Container(
            padding: const EdgeInsets.fromLTRB(10.0, 6.0, 10.0, 6.0),
            child: Wrap(
              spacing: 9.0,
              runSpacing: 4.0,
              children: grp.filters.map((filter) => _BlacklistButton(
                filter,
        ...
        child: Wrap(
          children: [
            RaisedButton(
              ...
              child: const Text('缓存', style: TextStyle(
                color: Colors.white,
                fontSize: 16.0,
              )),
            ),
...
class _BlacklistButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    child: RawMaterialButton(
      ...
      child: Text(filter.title, style: TextStyle(
        fontSize: 17.0,
